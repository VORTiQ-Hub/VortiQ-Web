...
export default function Navbar(){
    return(
        <div className="w-full flex justify-between px-6 py-3 sticky-top text-black bg-blue-950 dark:text-white dark:bg-blue-600">
            ...
            <div className="flex justify-center items-center gap-4 text-black dark:text-white">
                <Link href="/" className="text-white text-lg font-bold hover:text-gray-600" >Register</Link>
                <Link href="/" className="text-white text-lg font-bold hover:text-gray-600" >Login</Link>
            </div>
        </div>
    )
}